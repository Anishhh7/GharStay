...
export default function Home() {
  ...
  const testimonialsQ = useApi(() => testimonials.list({ limit: 1, approved: true }), []);
  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container intro-split">
          <div className="intro-split__text">
            ...
            <p>
              GharStay sits inside a village that was never built for tourism —
              it grew a resort instead. Every room was raised by a local
              building crew, every dish comes from terraces you can see from the
              dining room, and the trail behind the property is still how the
              neighboring farm gets its goods to market.
            </p>
            <Link
              to="/about"
          ...
          <div className="intro-split__image">
            <Photo
              id="garden"
              alt="Terraced garden beds at GharStay at golden hour"
            />
          </div>
        </div>
      </section>
      ...
      <section className="fullbleed-band">
        <Photo
          id="heroForestRoad"
          alt="Forest trail behind GharStay"
        ...
        <div className="container">
          ...
          {packageList.length > 0 && (
            <div className="package-split">
              <Link
                to={`/packages/${packageList[0].id || packageList[0]._id}`}
                className="package-split__feature"
              >
                ...
                <div className="package-split__feature-copy">
                  ...
                  <p>
                    {packageList[0].description?.slice(0, 140) ||
                      'A signature multi-night stay, curated by the resort team.'}
                  </p>
                </div>
              </Link>
              <div className="package-split__stack">
                {packageList.slice(1, 3).map((pkg, i) => (
                  ...
                  >
                    ...
                    <div>
                      <h5>{pkg.name}</h5>
                      <span className="package-split__price">
                        {pkg.price ? `$${pkg.price}` : 'Enquire'}
                      </span>
                    </div>
                  </Link>
                ))}
      ...
      <section className="restaurant-split">
        ...
        <div className="restaurant-split__copy">
          ...
          <p>
            No printed seasonal menu — because the season changes the plan
            daily. The kitchen walks the terraces each morning and builds that
            night's table around what's ready.
          </p>
          <div
            style={{
              display: 'flex',
      ...
      {featuredTestimonial && (
        <section className="testimonial-band">
          <div className="container-narrow">
            ...
            <blockquote>&ldquo;{featuredTestimonial.message}&rdquo;</blockquote>
        ...
        <div className="container">
          ...
          <div className="mixed-grid">
            ...
            <div className="mixed-grid__list">
              ...
              {!eventsQ.loading && eventList.length === 0 && (
                <EmptyNote text="No upcoming events posted yet." />
              )}
            </div>
          </div>
        </div>
